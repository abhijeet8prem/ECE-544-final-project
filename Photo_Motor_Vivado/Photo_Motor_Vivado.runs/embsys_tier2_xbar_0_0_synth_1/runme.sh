...
HD_PWD='D:/PSU_Work_and_Textbooks/ECE544/ECE544_ProjFinal/ECE-544-final-project/Photo_Motor_Vivado/Photo_Motor_Vivado.runs/embsys_tier2_xbar_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_tier2_xbar_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_tier2_xbar_0_0.tcl
