...
HD_PWD='D:/PSU_Work_and_Textbooks/ECE544/ECE544_ProjFinal/ECE-544-final-project/Photo_Motor_Vivado/Photo_Motor_Vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nexysA7fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nexysA7fpga.tcl
