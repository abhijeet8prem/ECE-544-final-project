...
HD_PWD='D:/PSU_Work_and_Textbooks/ECE544/ECE544_ProjFinal/Light_Motor_Vivado/Light_Motor_Vivado.runs/embsys_rst_clk_wiz_1_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_rst_clk_wiz_1_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_rst_clk_wiz_1_100M_0.tcl
