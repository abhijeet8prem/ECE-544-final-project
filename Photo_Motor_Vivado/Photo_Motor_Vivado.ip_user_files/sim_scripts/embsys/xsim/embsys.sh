...
elaborate()
{
  xelab --relax --debug typical --mt auto -L microblaze_v11_0_4 -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_2 -L interrupt_control_v3_1_4 -L axi_gpio_v2_0_24 -L lib_pkg_v1_0_2 -L axi_timer_v2_0_24 -L fit_timer_v2_0_10 -L lib_srl_fifo_v1_0_2 -L axi_uartlite_v2_0_26 -L lmb_v10_v3_0_11 -L lmb_bram_if_cntlr_v4_0_19 -L blk_mem_gen_v8_4_4 -L generic_baseblocks_v2_1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_22 -L fifo_generator_v13_2_5 -L axi_data_fifo_v2_1_21 -L axi_crossbar_v2_1_23 -L axi_intc_v4_1_15 -L xlconcat_v2_1_4 -L mdm_v3_2_19 -L proc_sys_reset_v5_0_13 -L dist_mem_gen_v8_0_13 -L lib_fifo_v1_0_14 -L axi_quad_spi_v3_2_21 -L xlslice_v1_0_2 -L axi_timebase_wdt_v3_0_14 -L xlconstant_v1_1_7 -L axi_protocol_converter_v2_1_22 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot embsys xil_defaultlib.embsys xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim embsys -key {Behavioral:sim_1:Functional:embsys} -tclbatch cmd.tcl -protoinst "protoinst_files/embsys.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb embsys.wdb xsim.dir)
