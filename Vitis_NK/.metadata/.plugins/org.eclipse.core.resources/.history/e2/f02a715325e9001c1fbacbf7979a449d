...
#define PWM_PERIOD 	100*1000*20;

#define DEFAULT_DUTY_PERCENTAGE 6.0f
...
int verticle_Duty_Percentage_Modifier = 0.0f;  // Duty Cycle modifier in terms of Percentage for Verticle Servo
int horizontal_Duty_Percentage_Modifier = 0.0f;  // Duty Cycle modifier in terms of Percentage for Verticle Servo
...
void OLED_Write_Signal(char letter1, char letter2 int value, int row){
	...
	OLEDrgb_PutString(&pmodOLEDrgb_inst, {letter1, letter2, '\0'});
